...
class _ProfilViewState extends State<ProfilView> {
  ...
  void initState() {
    super.initState();
    _user = widget.firebaseAuth.currentUser;
          ...
          child: Column(
            ...
            children: [
              ...
              Stack(
                children: [
                  CircleAvatar(
                    // Show user photo if available, otherwise show the default icon
                    backgroundImage: _user != null && _user!.photoURL != null
                        ? NetworkImage(_user!.photoURL!)
                        : const AssetImage(AssetsConstants.user) as ImageProvider,
                    radius: getSize(50),
                  ),
                  Positioned(
                    left: getSize(72),
